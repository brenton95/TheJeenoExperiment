...
| 009 | [ai2thor-golden-eval](009-2026-06-21-ai2thor-golden-eval.md) | 2026-06-21 | BLOCKED by 010 | End-to-end golden-path eval `eval_golden_ai2thor.py` ("go to the red apple", SmokeTest, two-tier: mock tier 2a here / `--live` tier 2b on Colab). Reconciled to the parametric refactor 2026-06-22. **Blocked:** its "consume the seam, zero edits" premise was false — `run_task_episode` was a stub; the episode runner was never wired. Unblocks after plan 010. |
